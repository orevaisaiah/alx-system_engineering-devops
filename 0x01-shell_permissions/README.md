0-iam_betty: This script is used to switche the current user to the user betty.
...
103-star_war: This script is used to play the StarWars IV episode in the terminal.
